...
void TextureManager::draw(string id, SDL_FRect* rect, SDL_RendererFlip flip)
{
	SDL_RenderCopyExF(GameManager::Instance()->getRenderer(), m_textureMap[id], NULL, rect, 0, 0, flip);
}
